...
class starter {
	...
	public static void main(String args[]) {
		...
		for(int i = 0; i < 6; i++){
			switch(i){
				case 0:
					if(dwarf2.isSameName(dwarf1.getName())) dup++;
					break;
				case 1:
					if(dwarf3.isSameName(dwarf1.getName())) dup++;
					break;
				case 2:
					if(dwarf4.isSameName(dwarf1.getName())) dup++;
					break;
				case 3:
					if(dwarf5.isSameName(dwarf1.getName())) dup++;
					break;
				case 4:
					if(dwarf6.isSameName(dwarf1.getName())) dup++;
					break;
				case 5:
					if(dwarf7.isSameName(dwarf1.getName())) dup++;
					break;
			}
		}
		System.out.println("\nThere is/are " + dup + " duplicates, of the name: " + dwarf1.getName());
